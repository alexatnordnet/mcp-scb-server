...
import { PX_WEB_API_REGISTRY, getApiConfig, getAvailableApis, getApisByCountry, getApisByLanguage, searchApis, createCustomApiConfig } from './registry.js';
...
export const PxWeb = {
    ...
    createClient: (apiId) => PxWebClient.fromRegistry(apiId),
    createCustomClient: (baseUrl, options) => PxWebClient.fromCustomEndpoint(baseUrl, options),
    // Quick info methods
    listApis: () => {
