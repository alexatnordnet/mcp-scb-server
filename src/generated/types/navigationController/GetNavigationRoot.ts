...
export type GetNavigationRootQueryParams = {
  /**
...
export const folderContentsTypeEnum2 = {
  Heading: 'Heading',
  FolderInformation: 'FolderInformation',
  Table: 'Table',
} as const

export type FolderContentsTypeEnum2 = (typeof folderContentsTypeEnum2)[keyof typeof folderContentsTypeEnum2]

/**
 * @description Success
 */
export type GetNavigationRoot200 = {
  /**
 ...
 */
export type GetNavigationRoot400 = {
  /**
 ...
 */
export type GetNavigationRoot404 = {
  /**
   * @description An absolute URI that identifies the problem type.  When dereferenced,\nit SHOULD provide human-readable documentation for the problem type\n(e.g., using HTML).\n
   * @default "about:blank"
   * @type string | undefined, uri
 ...
 */
export type GetNavigationRoot429 = {
  /**
   * @description An absolute URI that identifies the problem type.  When dereferenced,\nit SHOULD provide human-readable documentation for the problem type\n(e.g., using HTML).\n
   * @default "about:blank"
   * @type string | undefined, uri
...
export type GetNavigationRootQueryResponse = GetNavigationRoot200

export type GetNavigationRootQuery = {
  Response: GetNavigationRoot200
  QueryParams: GetNavigationRootQueryParams
  Errors: GetNavigationRoot400 | GetNavigationRoot404 | GetNavigationRoot429
}