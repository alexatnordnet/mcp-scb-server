...
export const getNavigationByIdPathParamsSchema = z.object({
  id: z.string().describe('Id'),
}) as unknown as ToZod<GetNavigationByIdPathParams>

export const getNavigationByIdQueryParamsSchema = z
  .object({
    lang: z.string().describe('The language if the default is not what you want.').nullable().nullish(),
  })
  .optional() as unknown as ToZod<GetNavigationByIdQueryParams>

/**
 * @description Success
 */
export const getNavigationById200Schema = z
  .object({
  ...
  .describe('Folder item') as unknown as ToZod<GetNavigationById200>

/**
 * @description Error response for 400
 */
export const getNavigationById400Schema = z.object({
  type: z
    .string()
    .url()
    .default('about:blank')
  ...
  instance: z
    ...
    .optional(),
}) as unknown as ToZod<GetNavigationById400>

/**
 * @description Error response for 404
 */
export const getNavigationById404Schema = z.object({
  type: z
    .string()
    .url()
    .default('about:blank')
  ...
  instance: z
    ...
    .describe('An absolute URI that identifies the specific occurrence of the problem.\nIt may or may not yield further information if dereferenced.\n')
    .optional(),
}) as unknown as ToZod<GetNavigationById404>

/**
 * @description Error response for 429
 */
export const getNavigationById429Schema = z.object({
  type: z
    .string()
    .url()
    .default('about:blank')
  ...
  instance: z
    ...
    .describe('An absolute URI that identifies the specific occurrence of the problem.\nIt may or may not yield further information if dereferenced.\n')
    .optional(),
}) as unknown as ToZod<GetNavigationById429>

export const getNavigationByIdQueryResponseSchema = z.lazy(() => getNavigationById200Schema) as unknown as ToZod<GetNavigationByIdQueryResponse>