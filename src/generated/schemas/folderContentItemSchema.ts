...
import type { FolderContentItem } from '../types/FolderContentItem.ts'
 ...
 */
export const folderContentItemSchema = z
  .object({
  ...
  .describe('Navigation item.') as unknown as ToZod<FolderContentItem>