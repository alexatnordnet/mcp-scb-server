...
} from '../../types/savedQueriesController/GetSaveQuery.ts'
import type { ToZod } from '@kubb/plugin-zod/utils'
import { z } from 'zod'

export const getSaveQueryPathParamsSchema = z.object({
  id: z.string().describe('Id'),
}) as unknown as ToZod<GetSaveQueryPathParams>

/**
 * @description Success
 */
export const getSaveQuery200Schema = z.object({
  ...
  outputFormatParams: z
    ...
    .optional(),
}) as unknown as ToZod<GetSaveQuery200>

/**
 * @description Error response for 400
 */
export const getSaveQuery400Schema = z.object({
  type: z
    .string()
    .url()
    .default('about:blank')
  ...
  instance: z
    ...
    .optional(),
}) as unknown as ToZod<GetSaveQuery400>

/**
 * @description Error response for 404
 */
export const getSaveQuery404Schema = z.object({
  type: z
    .string()
    .url()
    .default('about:blank')
  ...
  instance: z
    ...
    .describe('An absolute URI that identifies the specific occurrence of the problem.\nIt may or may not yield further information if dereferenced.\n')
    .optional(),
}) as unknown as ToZod<GetSaveQuery404>

/**
 * @description Error response for 429
 */
export const getSaveQuery429Schema = z.object({
  type: z
    .string()
    .url()
    .default('about:blank')
  ...
  instance: z
    ...
    .describe('An absolute URI that identifies the specific occurrence of the problem.\nIt may or may not yield further information if dereferenced.\n')
    .optional(),
}) as unknown as ToZod<GetSaveQuery429>

export const getSaveQueryQueryResponseSchema = z.lazy(() => getSaveQuery200Schema) as unknown as ToZod<GetSaveQueryQueryResponse>